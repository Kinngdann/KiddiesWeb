...
//     sort = (contestants) => {
//         return contestants.sort((a, b) => {
//             return b.votes.stageThree > a.votes.Three? 1 : -1
//         })
//     }
...
//         // this.state.sorted.map((i, j) => {
//         //     console.log('here','name:', i.name, 'vote:', i.votes.stageThree, 'position:', this.nth(j + 1), 'id:', i.id)
//         // })
